...
[[Subdomains, pointer domains, secondary domains]]
...
**Domain registrar**: Once DNS resolver receives a response from TLD nameservers, it'll query the domain registrar for the information regarding which authoritative nameservers hold the DNS zone file for a particular domain.
